...
<div class="card align-center" id="box">
    ...
    <div class="card-body mx-4" >
        ...
        <div class="text-center">
            <h3 class="dark-grey-text mb-5"><strong>Search Student</strong></h3>
        </div>
            
             <form  method="POST" onsubmit="return validate()" action="updateStudent">
        <!--Body-->
        <div class="md-form">
            <input type="text" id="Form-email1" class="form-control" onkeyup="clear_emailerr()" name="Username">
            <label for="Form-email1">Enter Student's Username</label>
        ...
        <div class="text-center mb-3">
            <button type="submit" class="btn blue-gradient btn-block btn-rounded z-depth-1a white-text" name="submit_btn"><strong><b>Search</b></strong></button>
        </div>
