...
<div id="box" class="card align-center" >
     ...
     <div class="text-center">
            <h1 class="dark-grey-text mb-5"><strong>Add Teacher</strong></h1>
        </div>
    ...
    <div class="card-body px-lg-5 pt-0">
        ...
        <form  class="text-center" style="color: #757575;" onsubmit="return validate()" method="post"  action="addTeacher">
            ...
            <div class="form-row">
              ...
              <!-- ParentSalary -->
            <div class="md-form">
                        <input type="text" id="Salary" class="form-control" onkeyup="clear_Salaryerr()" name="Salary">
...
<div class="form-row">
                ...
                <div class="col">
                  ...
                  <div class="form-group">
                                            <div class="md-form">
                        <input type="text" id="Qualification" class="form-control" onkeyup="clear_Qualificationerr()" name="Qualification">
