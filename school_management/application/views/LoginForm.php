    ...
    <div class="card-body mx-4" >
        ...
        <div class="text-center">
            <h3 class="dark-grey-text mb-5"><strong>Sign In</strong></h3>
             ...
             <form  method="POST" onsubmit="return validate()" action="login">
        <!--Body-->
        <div class="md-form">
        ...
        <div class="md-form pb-3">
            <input type="password" id="Form-pass1" class="form-control" onkeyup="clear_passworderr()" name="password">
        ...
        <div class="text-center mb-3">
            <button type="submit" class="btn blue-gradient btn-block btn-rounded z-depth-1a white-text" name="submit_btn"><strong><b>Login</b></strong></button>
        </div>
...
function validate() 
{
	...
	password=document.getElementById('Form-pass1').value;
