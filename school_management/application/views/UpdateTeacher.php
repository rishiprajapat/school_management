...
<div id="box" class="card align-center" >
     ...
     <div class="text-center">
            <h1 class="dark-grey-text mb-5"><strong>Update Teacher</strong></h1>
        </div>
    ...
    <div class="card-body px-lg-5 pt-0">
        ...
        <!-- Form -->
        <form  class="text-center" style="color: #757575;" onsubmit="return validate()" method="post"  action="addTeacher">
            ...
            <div class="form-row">
                <div class="col">
                    <!-- First name -->
                    <div class="md-form">
                        <input type="text" id="FirstName" class="form-control" onkeyup="clear_FirstNameerr()" name="FirstName" required value="<?php echo $fn ;?>">
                ...
                <div class="col">
                    <!-- Last name -->
                    <div class="md-form">
                        <input type="text" id="LastName" class="form-control" onkeyup="clear_LastNameerr()" name="LastName" required <?php echo $ln; ?>>
              ...
              <!-- ParentSalary -->
            <div class="md-form">
                        <input type="text" id="Salary" class="form-control" onkeyup="clear_Salaryerr()" name="Salary" required value="<?php echo $sal; ?>">
                ...
                <div class="col">
                    <!-- Username-->
                    <div class="md-form">
                        <input type="text" id="UserName" class="form-control" onkeyup="clear_UserNameerr()" name="UserName" required value="<?php echo $user; ?>">
                ...
                <div class="col">
                    <!-- password  -->
                    <div class="md-form">
                        <input type="password" id="Password" class="form-control" onkeyup="clear_Passworderr()" name="Password" required value="<?php echo $pass; ?>">
...
<br>
   ...
   <div class="form-row">
                ...
                <div class="col">
                    <!-- phone -->
                    <div class="md-form">
                        <input type="text" id="Phone" class="form-control" onkeyup="clear_phoneerr()" name="Phone" required value="<?php echo $pn; ?>">
...
<div class="form-row">
                ...
                <div class="col">
                  ...
                  <div class="form-group">
                                            <div class="md-form">
                        <input type="text" id="Qualification" class="form-control" onkeyup="clear_Qualificationerr()" name="Qualification" require value="<?php echo $qual; ?>">
            ...
            <div class="form-row">
<p>Select Year(use ctrl for multiple select)</p>
                          <select class="custom-select" multiple name="year[]">
 ...
 <!-- address -->
            ...
            <button type="submit" class="btn blue-gradient btn-block btn-rounded z-depth-1a white-text" name="submit_btn"><strong><b>Update</b></strong></button>
        </div>
