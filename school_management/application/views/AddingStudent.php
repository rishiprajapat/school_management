        ...
        <form  class="text-center" style="color: #757575;" onsubmit="return validate()" method="post"  action="addStudent">
            ...
            <div class="form-row">
                <div class="col">
                    <!-- First name -->
                    <div class="md-form">
                        <input type="text" id="FirstName" class="form-control" onkeyup="clear_FirstNameerr()" name="FirstName">
                ...
                <div class="col">
                    <!-- Last name -->
                    <div class="md-form">
                        <input type="text" id="LastName" class="form-control" onkeyup="clear_LastNameerr()" name="LastName">
                ...
                <div class="col">
                    <!-- Father name -->
                    <div class="md-form">
                        <input type="text" id="FatherName" class="form-control" onkeyup="clear_FatherNameerr()" name="FatherName">
                ...
                <div class="col">
                    <!-- mother name -->
                    <div class="md-form">
                        <input type="text" id="MotherName" class="form-control" onkeyup="clear_MotherNameerr()" name="MotherName">
              ...
              <!-- ParentSalary -->
            <div class="md-form">
                        <input type="text" id="ParentSalary" class="form-control" onkeyup="clear_ParentSalaryerr()" name="ParentSalary">
                ...
                <div class="col">
                    <!-- Username-->
                    <div class="md-form">
                        <input type="text" id="UserName" class="form-control" onkeyup="clear_UserNameerr()" name="UserName">
                ...
                <div class="col">
                    <!-- password  -->
                    <div class="md-form">
                        <input type="password" id="Password" class="form-control" onkeyup="clear_Passworderr()" name="Password">
  ...
  <div class="form-row">
                <div class="col">
                    ...
                    <div class="form-group ">
                                            ...
                                            <select class="form-control" name="Category" onselect="clear_Categoryerr">
                ...
                <div class="col">
                    <!-- DOB -->
                    <div class="md-form">
                        <input type="Date" id="DOB" class="form-control" onkeyup="clear_DOBerr()" name="DOB">
                        <label for="DOB"></label>
   ...
   <div class="form-row">
                <div class="col">
                    <!-- email-->
                    <div class="md-form">
                        <input type="text" id="Email" class="form-control" onkeyup="clear_Emailerr()" name="Email">
                ...
                <div class="col">
                    <!-- phone -->
                    <div class="md-form">
                        <input type="text" id="Phone" class="form-control" onkeyup="clear_phoneerr()" name="Phone">
...
<div class="form-row">
                ...
                <div class="col">
                  ...
                  <div class="form-group">
                                            <label>Year</label>
                                            <select class="form-control" name="Year" onselect="clear_Yearerr">
 ...
 <div class="form-row">
                <div class="col">
                    <!-- Father name -->
                    <div class="md-form">
                        <input type="text" id="10thboard" class="form-control" onkeyup="clear_10thboarderr()" name="Tenthboard">
                ...
                <div class="col">
                    <!-- mother name -->
                    <div class="md-form">
                        <input type="text" id="12thboard" class="form-control" onkeyup="clear_12thboarderr()" name="Twelvethboard">
 ...
 <!-- address -->
                    <div class="md-form">
                        <input type="text" id="Address" class="form-control" onkeyup="clear_Addresserr()" name="Address">
